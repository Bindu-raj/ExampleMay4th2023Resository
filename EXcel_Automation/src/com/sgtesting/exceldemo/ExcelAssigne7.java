...
public class ExcelAssigne7 {
	...
	private static void writeContent() {
		...
		try
		{
			fin=new FileInputStream("C:\\Excel\\Flowers.xlsx");
			...
			for(int r=0;r<rc;r++)
			{
				...
				for(int c=0;c<cc;c++)
				{
					rowsh2=sh2.getRow(c+6);
					if(rowsh2==null)
					{
						rowsh2=sh2.createRow(c+6);
					}
			...
			fout=new FileOutputStream("C:\\Excel\\Flowers.xlsx");
			wb.write(fout);
		}catch(Exception e)
		{
			e.printStackTrace();
